  ...
  return (
    <>
      <nav
        className={
          darkMode
            ? "bg-white border-gray-200 shadow-lg md:px-8 fixed w-full top-0"
            : "bg-gray-700 border-gray-200 shadow-lg md:px-8 fixed w-full top-0"
        }
      >
          ...
          <div className="flex md:hidden items-center">
            ...
            <div className="md:hidden" onClick={() => setToggle(!toggle)}>
              {!toggle ? (
                <motion.img
                  whileTap={{ rotate: 45 }}
                  src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/000000/external-menu-100-most-used-icons-flaticons-flat-flat-icons-2.png"
                  alt=""
                  className="w-8"
                />
              ) : (
      ...
      <AnimatePresence>
        {toggle && (
          <motion.div
            ...
            className="bg-white py-2 px-2 md:p-0 z-50 fixed top-16 mt-1 rounded-lg shadow-lg right-2 block w-40"
          >

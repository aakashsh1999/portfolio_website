...
const Home = () => {
  return (
    <>
    <div className="bg-fixed " style={{backgroundImage:`url('https://img.wallpapersafari.com/desktop/1920/1080/14/73/tWkswF.png')`}}>
      <main className="mx-auto max-w-7xl px-4  pt-36 sm:px-6 md:mt-0 lg:px-8 flex flex-col md:flex-row items-center md:h-screen" id='/'>
